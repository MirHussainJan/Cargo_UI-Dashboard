...
// Get the user from localStorage or default to null
const getUser = localStorage.getItem(localStorageKey) ? JSON.parse(localStorage.getItem(localStorageKey)) : null;
